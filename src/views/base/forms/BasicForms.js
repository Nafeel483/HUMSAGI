      ...
      <CRow>
              ...
              <CRow>
                <CCol xs="12">
                  <CFormGroup>
                    ...
                    <CInput id="name" placeholder="Please Enter your name" required />
                  </CFormGroup>
                </CCol>
              </CRow>
              <CRow>
                <CCol xs="12">
                  <CFormGroup>
                    <CLabel htmlFor="ccnumber">Your Address</CLabel>
                    <CInput id="ccnumber" placeholder="   " required />
                  </CFormGroup>
                </CCol>
              </CRow>
              <CRow>
                ...
                <CCol xs="4">
                  <CFormGroup>
                    <CLabel htmlFor="cvv">Current Time</CLabel>
                    <CInput id="cvv" placeholder=" " required/>
                  </CFormGroup>
                </CCol>
              </CRow>
            </CCardBody>
        ...
        <CCol xs="12" sm="6">
          <CCard>
            ...
            <CCardBody>
              <CFormGroup>
                <CLabel htmlFor="Society">Society</CLabel>
                <CInput id="Society" placeholder="Please Enter your Society name" />
              </CFormGroup>
              
              <CFormGroup>
                <CLabel htmlFor="street">Street</CLabel>
                <CInput id="street" placeholder="Enter street name or Street Number" />
              </CFormGroup>
              <CFormGroup>
                <CLabel htmlFor="House Number">House Number</CLabel>
                <CInput id="street" placeholder=" Please Enter House Number" />
              </CFormGroup>
              <CFormGroup row className="my-0">
                <CCol xs="8">
                  <CFormGroup>
                    <CLabel htmlFor="city">City</CLabel>
                    <CInput id="city" placeholder="Please Enter your city" />
                  </CFormGroup>
                </CCol>
                <CCol xs="4">
                  <CFormGroup>
