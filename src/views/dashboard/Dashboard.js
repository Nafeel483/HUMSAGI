    ...
    <>
      ...
      <CCard>
        <CCardBody>
          <CRow>
            <CCol sm="5">
              <h4 id="Neighbors" className="card-title mb-0">Neighbors</h4>
        ...
        <CCardFooter>
          <CRow className="text-center">
            <CCol md sm="12" className="mb-sm-2 mb-0">
              <div className="text-muted">Neighbors Visits</div>
            ...
            <CCol md sm="12" className="mb-sm-2 mb-0">
              <div className="text-muted">New Neighbors or User</div>
              <strong>22.123 Neighbors/Users (80%)</strong>
              <CProgress
                className="progress-xs mt-2"
                precision={1}
                color="danger"
              ...
              <CRow>
                <CCol xs="12" md="6" xl="6">
                  ...
                  <CRow>
                    <CCol sm="6">
                      <CCallout color="info">
                        <small className="text-muted">Neighbors/Users</small>
                        <br />
                ...
                <CCol xs="12" md="6" xl="6">
                  ...
                  <div className="progress-group">
                    <div className="progress-group-header">
                      ...
                      <span className="title"></span>
                      <span className="ml-auto font-weight-bold">512 <span className="text-muted small">(15%)</span></span>
                    </div>
                    <div className="progress-group-bars">
                  ...
                  <div className="progress-group">
                    <div className="progress-group-header">
                      ...
                      <span className="ml-auto font-weight-bold">375 <span className="text-muted small">(11%)</span></span>
                    </div>
                    <div className="progress-group-bars">
                  ...
                  <div className="progress-group">
                    <div className="progress-group-header">
                      ...
                      <span className="ml-auto font-weight-bold">271 <span className="text-muted small">(8%)</span></span>
                    </div>
                    <div className="progress-group-bars">
              ...
              <table className="table table-hover table-outline mb-0 d-none d-sm-table">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                      <div>Jawaria Maqbool</div>
                      <div className="small text-muted">
                        <span>New</span> | Registered: July, 04 2021
                      </div>
                    </td>
                    <td className="text-center">
                  ...
                  <tr>
                    ...
                    <td>
                      <div>Aatiqa Jabeen</div>
                      <div className="small text-muted">

                        <span>Recurring</span> | Registered: July 1, 2021
                      </div>
                    </td>
                    <td className="text-center">
                  ...
                  <tr>
                    ...
                    <td>
                      <div>Neha Shakeel</div>
                      <div className="small text-muted">
                        <span>New</span> | Registered: July 6, 2021
                      </div>
                    </td>
                    <td className="text-center">
                  ...
                  <tr>
                    <td className="text-center">
                      <div className="c-avatar">
                        <img src={'avatars/4.jpg'} className="c-avatar-img" alt="admin@bootstrapmaster" />
                  ...
                  <tr>
                    ...
                    <td>
                      <div>Mavish</div>
                      <div className="small text-muted">
                        <span>New</span> | Registered: Feb 1, 2021
                      </div>
                    </td>
                    <td className="text-center">
                  ...
                  <tr>
                    ...
                    <td>
                      <div>Fatima</div>
                      <div className="small text-muted">
                        <span>New</span> | Registered: Mar 5, 2021
                      </div>
                    </td>
                    <td className="text-center">
